  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        />
        <View>
          <Text style={{ color: 'black', fontSize: w('4.5%') }}>
            <Text style={{ fontWeight: '600' }}>Author:</Text> {author}
          </Text>
          <Text style={{ color: 'black', fontSize: w('4.5%') }}>
            <Text style={{ fontWeight: '600' }}>Genre:</Text> {genre}
          </Text>
          <Text
            numberOfLines={3}
            style={{ color: 'black', fontSize: w('4.5%') }}
          >
            <Text style={{ fontWeight: '600' }}>Title:</Text> {title}
            {subtitle}
          </Text>
          <Text style={{ fontSize: w('4.5%') }}>
            <Text style={{ fontWeight: '600' }}>Released:</Text> {releaseDate}
          </Text>
        </View>
